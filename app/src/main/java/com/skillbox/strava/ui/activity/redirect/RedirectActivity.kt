...
class RedirectActivity : BaseActivity(R.layout.activity_redirect) {
    ...
    private val ivLogin get() = checkNotNull(_ivLogin) { "ImageView ivLogin RedirectActivity isn`n initialized" }

    private var _webView: WebView? = null
    private val webView get() = checkNotNull(_webView) { "WebView webView RedirectActivity isn`n initialized" }

    private var _toolBar: Toolbar? = null
    private val toolBar get() = checkNotNull(_toolBar) { "Toolbar toolBar RedirectActivity isn`n initialized" }
